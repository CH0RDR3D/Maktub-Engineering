...
function InteractiveMesh() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        ...
        const maxPulses = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 16;
        const orbCount = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 4;
        function initOrbs() {
            orbs = [];
            for(let i = 0; i < orbCount; i++){
                ...
                orbs.push({
                    ...
                    radius: Math.random() * 80 + (("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 160),
                    isGold: isGold,
        ...
        function onPointerDown(e) {
            ...
            shockwaves.push({
                ...
                y: clientY,
                radius: 0,
                maxRadius: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 320,
                speed: ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 550,
                force: 7,
                alpha: 0.8
            });
        }
        ...
        function loop(currentTime) {
            ...
            if (mouse.active && mouse.x > -100 && mouse.y > -100) {
                const outerGlowRadius = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 250;
                const innerGlowRadius = ("TURBOPACK compile-time falsy", 0) ? "TURBOPACK unreachable" : 80;
